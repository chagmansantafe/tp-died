...
public class ListaTab extends JPanel{
	...
	*/
	...
	ListaTab(Sucursal sucursal, String tipo){
		
		this.setLayout(new BorderLayout());
		Border border = BorderFactory.createLineBorder(Color.WHITE, 1);
        this.setBorder(border);

		JScrollPane scrollPane = new JScrollPane(new ListaPane(sucursal,tipo));
	...
	ListaTab(HashMap<Producto,Integer> listaProductos){
