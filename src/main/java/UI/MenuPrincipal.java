...
MenuPrincipal(){
 ...
 private Container menu() {
     ...
     sucursales.addActionListener(e -> {
    	 ...
    	 ArrayList<Sucursal> listaSucursal = (new ListaSucursales()).getLista();
     ...
     caminos.addActionListener(e -> {
         // Switch to the other panel when the button is clicked.
    	 ArrayList<Camino> listaCamino = (new ListaCaminos()).getLista();
     ...
     productos.addActionListener(e -> {
         // Switch to the other panel when the button is clicked.
    	 ArrayList<Producto> listaProducto = (new ListaProductos()).getLista();
...
Container productosScreen( ArrayList<Producto> listaProducto) {
    ...
    ListaTab panelIzquierda = new ListaTab(listaProducto);
    ...
    precio.addActionListener(e -> {
   	 //panelIzuierda.ordenar("nombre",nombre)
   	 //actualizar lista
   	 this.revalidate();
   	 this.repaint();
    });
    ...
    peso.addActionListener(e -> {
   	 //panelIzuierda.ordenar("estado",estado)
   	 //actualizar lista
   	 this.revalidate();
   	 this.repaint();
    });
 ...
 Container caminosScreen(ArrayList<Camino> listaCamino) {
    ...
    ListaTab panelIzquierda = new ListaTab(listaCamino);
  ...
  Container sucursalScreen(ArrayList<Sucursal> listaSucursal) {
	...
	//background panel (extiende JPanel)
     ...
     //LISTA
     ListaTab panelIzquierda = new ListaTab(listaSucursal);
     ...
     //TODO
     id.addActionListener(e -> {
    	 //actualizarPanelSucursales(backgroundPanel, listaSucursal, panelIzquierda);
     });
